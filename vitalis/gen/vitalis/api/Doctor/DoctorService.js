...
import { DoctorRepository } from "../../dao/Doctor/DoctorRepository";
import { ValidationError } from "../utils/ValidationError";
import { HttpUtils } from "../utils/HttpUtils";
const validationModules = await Extensions.loadExtensionModules("vitalis-Doctor-Doctor", ["validate"]);
let DoctorService = (() => {
    ...
    var DoctorService = _classThis = class {
        constructor() {
            this.repository = (__runInitializers(this, _instanceExtraInitializers), new DoctorRepository());
        }
        getAll(_, ctx) {
            try {
                const options = {
        ...
        create(entity) {
            try {
                ...
                response.setHeader("Content-Location", "/services/ts/vitalis/gen/vitalis/api/Doctor/DoctorService.ts/" + entity.Id);
        ...
        getById(_, ctx) {
            try {
                ...
                if (entity) {
                    ...
                    HttpUtils.sendResponseNotFound("Doctor not found");
                }
            }
            catch (error) {
                this.handleError(error);
