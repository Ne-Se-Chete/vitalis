...
import { MeasurementsRepository } from "../../dao/Measurements/MeasurementsRepository";
import { ValidationError } from "../utils/ValidationError";
import { HttpUtils } from "../utils/HttpUtils";
const validationModules = await Extensions.loadExtensionModules("vitalis-Measurements-Measurements", ["validate"]);
let MeasurementsService = (() => {
    ...
    var MeasurementsService = _classThis = class {
        constructor() {
            this.repository = (__runInitializers(this, _instanceExtraInitializers), new MeasurementsRepository());
        }
        getAll(_, ctx) {
            try {
                const options = {
        ...
        create(entity) {
            try {
                ...
                response.setHeader("Content-Location", "/services/ts/vitalis/gen/vitalis/api/Measurements/MeasurementsService.ts/" + entity.Id);
        ...
        getById(_, ctx) {
            try {
                ...
                if (entity) {
                    ...
                    HttpUtils.sendResponseNotFound("Measurements not found");
                }
            }
            catch (error) {
                this.handleError(error);
        ...
        validateEntity(entity) {
            var _a;
            if (((_a = entity.ECG) === null || _a === void 0 ? void 0 : _a.length) > 20000) {
    ...
    __setFunctionName(_classThis, "MeasurementsService");
    (() => {
        ...
        MeasurementsService = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return MeasurementsService = _classThis;
})();
