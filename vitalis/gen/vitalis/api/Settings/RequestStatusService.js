...
import { RequestStatusRepository } from "../../dao/Settings/RequestStatusRepository";
import { ValidationError } from "../utils/ValidationError";
import { HttpUtils } from "../utils/HttpUtils";
const validationModules = await Extensions.loadExtensionModules("vitalis-Settings-RequestStatus", ["validate"]);
let RequestStatusService = (() => {
    ...
    var RequestStatusService = _classThis = class {
        constructor() {
            this.repository = (__runInitializers(this, _instanceExtraInitializers), new RequestStatusRepository());
        }
        getAll(_, ctx) {
            try {
                const options = {
        ...
        create(entity) {
            try {
                ...
                response.setHeader("Content-Location", "/services/ts/vitalis/gen/vitalis/api/Settings/RequestStatusService.ts/" + entity.Id);
        ...
        getById(_, ctx) {
            try {
                ...
                if (entity) {
                    ...
                    HttpUtils.sendResponseNotFound("RequestStatus not found");
                }
            }
            catch (error) {
                this.handleError(error);
    ...
    __setFunctionName(_classThis, "RequestStatusService");
    (() => {
        ...
        RequestStatusService = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return RequestStatusService = _classThis;
})();
