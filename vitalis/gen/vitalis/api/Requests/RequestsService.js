...
import { RequestsRepository } from "../../dao/Requests/RequestsRepository";
import { user } from "sdk/security";
import { ForbiddenError } from "../utils/ForbiddenError";
import { ValidationError } from "../utils/ValidationError";
import { HttpUtils } from "../utils/HttpUtils";
const validationModules = await Extensions.loadExtensionModules("vitalis-Requests-Requests", ["validate"]);
let RequestsService = (() => {
    ...
    var RequestsService = _classThis = class {
        constructor() {
            this.repository = (__runInitializers(this, _instanceExtraInitializers), new RequestsRepository());
        }
        getAll(_, ctx) {
            try {
        ...
        create(entity) {
            try {
                ...
                response.setHeader("Content-Location", "/services/ts/vitalis/gen/vitalis/api/Requests/RequestsService.ts/" + entity.Id);
        ...
        getById(_, ctx) {
            try {
                ...
                if (entity) {
                    ...
                    HttpUtils.sendResponseNotFound("Requests not found");
                }
            }
            catch (error) {
                this.handleError(error);
        ...
        checkPermissions(operationType) {
            if (!user.isInRole("Requests")) {
                throw new ForbiddenError();
            }
        }
        validateEntity(entity) {
            var _a;
            if (((_a = entity.Description) === null || _a === void 0 ? void 0 : _a.length) > 555) {
                throw new ValidationError(`The 'Description' exceeds the maximum length of [555] characters`);
            }
    ...
    __setFunctionName(_classThis, "RequestsService");
    (() => {
        ...
        RequestsService = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return RequestsService = _classThis;
})();
