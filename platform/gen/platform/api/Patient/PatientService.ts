...
import { PatientRepository, PatientEntityOptions } from "../../dao/Patient/PatientRepository";
import { ValidationError } from "../utils/ValidationError";
import { HttpUtils } from "../utils/HttpUtils";

const validationModules = await Extensions.loadExtensionModules("platform-Patient-Patient", ["validate"]);
...
class PatientService {
    ...
    public getAll(_: any, ctx: any) {
        try {
            const options: PatientEntityOptions = {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/platform/gen/platform/api/Patient/PatientService.ts/" + entity.Id);
