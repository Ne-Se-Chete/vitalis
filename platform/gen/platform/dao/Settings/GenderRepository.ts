...
export class GenderRepository {
    ...
    private async triggerEvent(data: GenderEntityEvent | GenderUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("platform-Settings-Gender", ["trigger"]);
        ...
        producer.topic("platform-Settings-Gender").send(JSON.stringify(data));
    }
}
