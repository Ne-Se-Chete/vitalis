...
export class DoctorRepository {
    ...
    private async triggerEvent(data: DoctorEntityEvent | DoctorUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("platform-Doctor-Doctor", ["trigger"]);
        ...
        producer.topic("platform-Doctor-Doctor").send(JSON.stringify(data));
    }
}
